  ...
  <NFlex vertical :size="16">
    ...
    >
      ...
      <template v-if="configBool('feat_clutch_assist')">
        ...
        <NFlex justify="space-between" align="center" :size="8" style="margin-top: 10px">
        ...
        <NFlex justify="space-between" align="center" style="margin-bottom: 4px">
          ...
          <NText code style="font-family: ui-monospace, monospace">
            {{ configNumber('blip_ms') }}ms
          </NText>
        </NFlex>
        <NSlider
          :value="configNumber('blip_ms')"
          :min="20"
          :max="150"
          :step="5"
          style="margin-bottom: 4px"
          @update:value="(v) => store.setConfig('blip_ms', v)"
        />
